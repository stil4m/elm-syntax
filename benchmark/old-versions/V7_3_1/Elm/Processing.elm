module V7_3_1.Elm.Processing exposing
    ( ProcessContext
...
import V7_3_1.Elm.Dependency exposing (Dependency)
import V7_3_1.Elm.Interface as Interface exposing (Interface)
import V7_3_1.Elm.Internal.RawFile as InternalRawFile
import V7_3_1.Elm.Operators exposing (SimpleInfix)
import V7_3_1.Elm.RawFile as RawFile
import V7_3_1.Elm.Syntax.Comments exposing (Comment)
...
import V7_3_1.Elm.Syntax.Infix exposing (InfixDirection(..))
        ...
        operatorsInArguments =
            List.filterMap
                (\(Node _ expression) ->
                    case expression of
                        Operator symbol ->
                            Dict.get symbol V7_3_1.Elm.Operators.bySymbol
