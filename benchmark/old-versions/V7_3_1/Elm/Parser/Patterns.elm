module V7_3_1.Elm.Parser.Patterns exposing (pattern)

import Parser as Core
import V7_3_1.Combine as Combine exposing (Parser, between, many, maybe, parens, sepBy, string)
import V7_3_1.Elm.Parser.Base as Base
...
import V7_3_1.Elm.Parser.Tokens exposing (characterLiteral, functionName, stringLiteral)
import V7_3_1.Elm.Syntax.Node as Node exposing (Node(..))
import V7_3_1.Elm.Syntax.Pattern exposing (Pattern(..), QualifiedNameRef)
...
numberPart =
    V7_3_1.Elm.Parser.Numbers.number FloatPattern IntPattern HexPattern
