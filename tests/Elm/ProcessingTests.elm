    ...
    , { comments = []
      , declarations =
            [ Node { end = { column = 21, row = 6 }, start = { column = 1, row = 4 } }
                (FunctionDeclaration
                    { declaration = Node { end = { column = 21, row = 6 }, start = { column = 1, row = 5 } } { arguments = [ Node { end = { column = 6, row = 5 }, start = { column = 5, row = 5 } } (VarPattern_ "a") ], expression = Node { end = { column = 21, row = 6 }, start = { column = 5, row = 6 } } (Application (Node { end = { column = 14, row = 6 }, start = { column = 5, row = 6 } } (FunctionOrValue [ "Debug" ] "log")) [ Node { end = { column = 19, row = 6 }, start = { column = 15, row = 6 } } (Literal SingleQuote "ok"), Node { end = { column = 21, row = 6 }, start = { column = 20, row = 6 } } (FunctionOrValue [] "a") ]), name = Node { end = { column = 4, row = 5 }, start = { column = 1, row = 5 } } "log" }
                    , documentation = Nothing
