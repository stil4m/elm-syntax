                                    ...
                                    \result ->
                                        ...
                                        , syntax =
                                            FunctionDeclarationAfterDocumentation
                                                { startName =
                                                    Node
                                                        { start = { row = startNameStartRow, column = startNameStartColumn }
                ...
                \nameEndColumn ->
                    \argumentsReverse ->
                        let
                            ...
                            nameEnd : Location
                            nameEnd =
                                { row = nameStartRow, column = nameEndColumn }
                        ...
                        , syntax =
                            Node { start = start, end = fullEnd }
                                { name = Node { start = start, end = nameEnd } name
